        ...
        <asp:Panel runat="server" DefaultButton="RegisterBtn">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="Email" ValidationGroup="RegisterGroup"
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-10">
                    <asp:Button runat="server" ID="RegisterBtn" OnClick="CreateUser_Click" Text="Register" CssClass="btn btn-default" />
                </div>
            </div>
        </asp:Panel>
    </div>
